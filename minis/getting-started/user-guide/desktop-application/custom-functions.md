...
![](../../../../.gitbook/assets/image%20%2885%29.png) : It gives a dc signal with a desired offset.

![](../../../../.gitbook/assets/image%20%2823%29.png) : It gives a sine signal with a desired offset, amplitude, phase and frequency.

![](../../../../.gitbook/assets/image%20%2864%29.png) : It gives a cosine signal with a desired offset, amplitude, phase and frequency.

![](../../../../.gitbook/assets/image%20%2848%29.png) : It gives a square signal with a desired offset, amplitude, phase and frequency.

### **Functions**

\*\*\*\*![](../../../../.gitbook/assets/image%20%2878%29.png) : The basic operations. All of them take 2 inputs.  

![](../../../../.gitbook/assets/image%20%2844%29.png) : Logic AND gate. It takes 2 inputs.

![](../../../../.gitbook/assets/image%20%2882%29.png) : Logic NAND gate. It takes 2 inputs.
...
![](../../../../.gitbook/assets/image%20%2867%29.png) : Logic XNOR gate. It takes 2 inputs.

![](../../../../.gitbook/assets/image%20%2887%29.png) : Logic NOT gate. It takes only 1 input.
...
![](../../../../.gitbook/assets/image%20%2869%29.png) : Comparator. If Input1 &gt; Input2, the output is VCC+, otherwise VCC-.
...
![](../../../../.gitbook/assets/image%20%2893%29.png) : High Pass Filter.

![](../../../../.gitbook/assets/image%20%2884%29.png) : Band Pass Filter.
...
![](../../../../.gitbook/assets/image%20%2863%29.png) : The output. To complete the block diagram, you need to add this block to the end. Every out block corresponds a new signal.
...
When you click the ![](../../../../.gitbook/assets/image%20%2886%29.png) button, the software checks the connections and create a new signal that is calculated according to the block diagram. If there are any problems in the connection, the software shows the error message. 
